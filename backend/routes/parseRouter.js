...
router.post('/',  upload.single('file'), (req,res)=>{
    ...
    const parseInvoice = async () => {
        try {
            ...
            const q = ' INSERT INTO records (invoicenumber, customername, customeraddress, suppliername, supplieraddress, invoicedate, currency, totalamount, totaltax, fileurl) VALUES (?)'
            const values = [invoiceNumber, customerName, customerAddress, supplierName, supplierAddress, invoiceDate, currency, totalAmount, totalTax, fileURL ]
